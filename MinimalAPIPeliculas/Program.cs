...
builder.Services.AddSwaggerGen( c =>
{
    ...
    {
        Title = "Peliculas API",
        Description = "Este es un Web API para trabajar peliculas con datos",
        Contact = new OpenApiContact
        {
            Email = "eduardozequeira00@gmail.com",
            Name = "Eduardo Zequeira",
        },
...
builder.Services.AddTransient<IRepositorioErrores, RepositorioErrores>();
...
app.MapGroup("/pelicula/{peliculaId}/comentarios").MapComentarios();
app.MapGroup("/usuarios").MapUsuarios();

app.MapGet("/", [EnableCors(policyName: "libre")] () => "¡Hola, mundo!");
app.MapGet("/error", () =>
{
    throw new InvalidOperationException("Error ejemplo");
});
